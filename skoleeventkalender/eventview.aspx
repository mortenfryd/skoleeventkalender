...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <asp:DropDownList ID="selectedEvent" CssClass="dropdown" runat="server" AutoPostBack="True" OnSelectedIndexChanged="selectedEvent_SelectedIndexChanged">
    </asp:DropDownList>
    <asp:Button CssClass="btn" ID="tilmeldEvent" runat="server" Text="Sign up for event" OnClick="tilmeldEvent_Click" />
    <asp:Button CssClass="btn" ID="DeleteEvent" runat="server" Text="Delete event" OnClick="DeleteEvent_Click" /> <br />
